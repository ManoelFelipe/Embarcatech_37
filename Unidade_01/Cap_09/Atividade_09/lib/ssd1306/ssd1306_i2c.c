 ...
 *          relacionadas à funcionalidade do módulo representado pelo caminho `lib/ssd1306/ssd1306_i2c.c`.
...
/**
 * @brief Descrição da função calculate_render_area_buffer_length.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param area Descrição do parâmetro area.
 */
...
/**
 * @brief Descrição da função ssd1306_send_command.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param command Descrição do parâmetro command.
 */
...
/**
 * @brief Descrição da função ssd1306_send_command_list.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 * @param number Descrição do parâmetro number.
 */
...
/**
 * @brief Descrição da função ssd1306_send_buffer.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd[] Descrição do parâmetro ssd[].
 * @param buffer_length Descrição do parâmetro buffer_length.
 */
...
/**
 * @brief Descrição da função ssd1306_init.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 */
...
/**
 * @brief Descrição da função ssd1306_scroll.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param set Descrição do parâmetro set.
 */
...
/**
 * @brief Descrição da função render_on_display.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 * @param area Descrição do parâmetro area.
...
/**
 * @brief Descrição da função ssd1306_set_pixel.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
...
/**
 * @brief Descrição da função ssd1306_draw_line.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 * @param x_0 Descrição do parâmetro x_0.
 * @param y_0 Descrição do parâmetro y_0.
 * @param x_1 Descrição do parâmetro x_1.
 * @param y_1 Descrição do parâmetro y_1.
 * @param set Descrição do parâmetro set.
 */
...
/**
 * @brief Descrição da função ssd1306_get_font.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param character Descrição do parâmetro character.
...
/**
 * @brief Descrição da função ssd1306_draw_char.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 * @param x Descrição do parâmetro x.
...
/**
 * @brief Descrição da função ssd1306_draw_string.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 * @param x Descrição do parâmetro x.
 * @param y Descrição do parâmetro y.
 * @param string Descrição do parâmetro string.
 */
...
/**
 * @brief Descrição da função ssd1306_command.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 * @param command Descrição do parâmetro command.
...
/**
 * @brief Descrição da função ssd1306_config.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 */
...
/**
 * @brief Descrição da função ssd1306_init_bm.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 * @param width Descrição do parâmetro width.
 * @param height Descrição do parâmetro height.
 * @param external_vcc Descrição do parâmetro external_vcc.
 * @param address Descrição do parâmetro address.
 * @param i2c Descrição do parâmetro i2c.
 */
...
/**
 * @brief Descrição da função ssd1306_send_data.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 */
...
/**
 * @brief Descrição da função ssd1306_draw_bitmap.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
...
/**
 * @brief Descrição da função ssd1306_clear_display.
 *
 * @details Explique aqui a lógica da função, parâmetros de entrada e o que ela retorna.
 * @param ssd Descrição do parâmetro ssd.
 */
